...
export function Signup() {
  ...
  const handleSendOtp = (e) => {
    ...
    if (name.trim().length < 3) {
      setError('Please enter a valid User Name (min 3 characters).');
      return;
    }
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 bg-primary relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-white max-w-md text-center p-8">
          ...
          <h1 className="text-4xl font-heading font-bold mb-4">Start Eating Fresh</h1>
          <p className="text-lg text-white/90">Join us today to get farm-fresh fruits and vegetables delivered straight to your door.</p>
        </div>
      </div>

      {/* Right Column - Form */}
      <div className="flex-1 flex flex-col items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative overflow-y-auto">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-heading font-bold text-textMain mb-2">
              {step === 'input' ? 'Create an Account' : 'Verify Details'}
            </h2>
          ...
          {step === 'input' ? (
            <form onSubmit={handleSendOtp} className="space-y-5">
              ...
              {/* Auth Method Toggle */}
              <div className="flex p-1 bg-gray-100 rounded-lg mt-2">
                <button 
                  type="button"
              ...
              <Button type="submit" className="w-full h-12 text-lg font-semibold flex items-center justify-center gap-2 mt-4">
